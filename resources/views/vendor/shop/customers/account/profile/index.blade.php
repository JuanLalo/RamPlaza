<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        <div class="flex items-center justify-between">
            ...
            @if($ramBaseUrl)
                <a
                    href="{{ rtrim($ramBaseUrl, '/') }}/setting/profile-setting"
                    target="_blank"
                    class="secondary-button border-zinc-200 px-5 py-3 font-normal max-md:rounded-lg max-md:py-2 max-sm:py-1.5 max-sm:text-sm flex items-center gap-2"
                >
